...
def main():
    ...
    model = timm.create_model("efficientnet_b8", pretrained=False, num_classes=1, in_chans=224)
    loss_fn = nn.MSELoss()
    ...
    for train_index, val_index in kf.split(data):
        ...
        for epoch in tqdm(range(EPOCH)):
            ...
            with open("contrast_efficientnet_b8_age.txt", "a+") as f:
                f.write(output + "\n")
            ...
            if MAE < best_mae:
                ...
                # }
                torch.save(model.state_dict(), "contrast_efficientnet_b8_age.pth")
