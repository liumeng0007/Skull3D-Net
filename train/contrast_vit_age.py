...
def main():
    ...
    model = timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=1, in_chans=224)
    loss_fn = nn.MSELoss()
    ...
    for train_index, val_index in kf.split(data):
        ...
        for epoch in tqdm(range(EPOCH)):
            ...
            with open("contrast_vit_age.txt", "a+") as f:
                f.write(output + "\n")
            ...
            if MAE < best_mae:
                ...
                # }
                torch.save(model.state_dict(), "contrast_vit_age.pth")
